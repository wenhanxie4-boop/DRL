# Global-state ablation environment for plain MLP PPO.
# Use this with ppo_continuous.py to test the value of global observation
# without the cross-attention network used by ppo_continuous_CA.py.
...
# 消融实验  普通的全局视野版255维，无cross-attention   和基础版本的CA本质上是同一个环境
